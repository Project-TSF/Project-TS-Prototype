...
public class PawnBehaviorList
{
    ...
    #region Action
        ...
        public bool Behavior_Action_NormalAttack(Pawn fromPawn, Pawn toPawn, int amount)
        {
        ...
        public bool Behavior_Action_SanityAttack(Pawn fromPawn, Pawn toPawn, int amount)
        {
